            ...
            <main>
                <div class="page-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted">Manage and review all quotations</p>
                    </div>
                </div>
                    ...
                    <div class="card quotation-card">
                        <div class="card-body">
                                ...
                                <form method="get" id="filterForm">
                                    <div class="row g-2 align-items-end">
                                        ...
                                        <div class="col-md-2 col-lg-auto d-flex gap-1 align-items-end">
                                            ...
                                            <a href="<?= BASE_URL ?>modules/quotations/quotation_list.php" class="btn btn-outline-secondary btn-clear">
                            ...
                            <div class="d-flex justify-content-start mt-2 mb-2">
                                <span class="search-count"><?php echo $totalRows; ?> Quotation<?= $totalRows !== 1 ? 's' : '' ?></span>
                            </div>
                                        ...
                                        <?php if ($result && $result->num_rows > 0): ?>
                                            <?php while ($row = $result->fetch_assoc()): ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <span class="badge-soft badge-soft-<?php echo strtolower($row['status']); ?>">
...
<td>
                            <div class="action-btn-group d-flex gap-1">
                                ...
                                <?php endif; ?>
                                            ...
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr><td colspan="9" class="text-center empty-state"><i class="fas fa-file-alt"></i><p>No quotations found</p></td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
