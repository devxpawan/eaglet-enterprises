...
<head>
    ...
    <title>Cancelled Quotations</title>
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="page-header d-flex justify-content-between align-items-center">
                    <div>
                        <h5>Cancelled Quotations</h5>
                        <p class="text-muted">View cancelled and rejected quotations</p>
                    </div>
                </div>
                    ...
                    <div class="card quotation-card">
                        <div class="card-body">
                                ...
                                <form method="get" id="filterForm">
                                    <div class="row g-2 align-items-end">
                                        <div class="col-md-3 col-lg-2">
                                            ...
                                            <input type="text" name="search" class="form-control" placeholder="Search by quotation ID or ref..."
                                        ...
                                        <div class="col-md-2 col-lg-auto d-flex gap-1 align-items-end">
                                            ...
                                            <a href="<?= BASE_URL ?>modules/quotations/cancelled_quotation_list.php" class="btn btn-outline-secondary btn-clear">
                            ...
                            <div class="d-flex justify-content-start mt-2 mb-2">
                                <span class="search-count"><?php echo $totalRows; ?> Cancelled Quotation<?= $totalRows !== 1 ? 's' : '' ?></span>
                            </div>
...
<td>
                            <div class="action-btn-group d-flex gap-1">
                                ...
                                <?php endif; ?>
                                            ...
                                            <?php endwhile; ?>
                                        <?php else: ?>
                                            <tr><td colspan="9" class="text-center empty-state"><i class="fas fa-file-alt"></i><p>No Cancelled quotations found</p></td></tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                            </div>
